...
import mr.rowad.application.repository.ProjectEventRepository;
import mr.rowad.application.service.ProjectEventService;
import mr.rowad.application.web.rest.errors.ExceptionTranslator;
import mr.rowad.application.service.dto.ProjectEventCriteria;
import mr.rowad.application.service.ProjectEventQueryService;
...
import static mr.rowad.application.web.rest.TestUtil.createFormattingConversionService;
...
public class ProjectEventResourceIntTest {
    ...
    public void updateProjectEvent() throws Exception {
        ...
        ProjectEvent updatedProjectEvent = projectEventRepository.findById(projectEvent.getId()).get();
