...
import mr.rowad.application.service.ProjectFileService;
...
import mr.rowad.application.service.ProjectFileQueryService;
...
public class ProjectFileResourceIntTest {
    ...
    public void updateProjectFile() throws Exception {
        ...
        ProjectFile updatedProjectFile = projectFileRepository.findById(projectFile.getId()).get();
