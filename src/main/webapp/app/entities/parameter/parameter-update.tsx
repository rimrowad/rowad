...
export interface IParameterUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export class ParameterUpdate extends React.Component<IParameterUpdateProps, IParameterUpdateState> {
  ...
  render() {
    const { parameterEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rowadApp.parameter.home.createOrEditLabel">
              <Translate contentKey="rowadApp.parameter.home.createOrEditLabel">Create or edit a Parameter</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : parameterEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="parameter-type" type="text" name="type" />
                </AvGroup>
                <AvGroup>
