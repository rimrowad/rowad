...
export type IParameterState = IPaginationBaseState;
...
export class Parameter extends React.Component<IParameterProps, IParameterState> {
  ...
  render() {
    const { parameterList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="parameter-heading">
          <Translate contentKey="rowadApp.parameter.home.title">Parameters</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="rowadApp.parameter.home.createLabel">Create new Parameter</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('type')}>
                  <Translate contentKey="rowadApp.parameter.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('value')}>
                  <Translate contentKey="rowadApp.parameter.value">Value</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
